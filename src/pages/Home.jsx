...
function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#05010a] text-white relative overflow-hidden font-sans flex flex-col">
            ...
            <section id="demo-video" className="relative z-10 max-w-6xl mx-auto px-6 py-32 text-center w-full">
                ...
                <div className="relative aspect-video bg-[#1e103c]/40 backdrop-blur-xl border-4 border-purple-500/20 rounded-3xl p-2 shadow-2xl group hover:border-purple-500/50 transition-all duration-500 overflow-hidden">
                    <div className="w-full h-full bg-[#130927] rounded-2xl relative overflow-hidden">
                        <video
                            controls
    playsInline
    className="absolute inset-0 w-full h-full object-cover rounded-2xl"
            ...
            <section className="relative z-10 max-w-6xl mx-auto px-6 mt-32 pb-32 pt-10 grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                <div className="bg-[#1e103c]/40 backdrop-blur-xl border border-purple-500/20 p-8 rounded-3xl hover:border-purple-500/60 hover:-translate-y-2 transition-all duration-300 shadow-[0_0_0_rgba(0,0,0,0)] hover:shadow-[0_15px_30px_rgba(168,85,247,0.15)] group">
